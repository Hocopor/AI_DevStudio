...
const AGENTS = [
  ...
  { id: 'backend_dev',  label: 'Backend Dev' },
]
...
export default function CreateTaskModal({ projectId, onClose, onCreated }: any) {
  ...
  const submit = async () => {
    ...
    try {
      ...
      setError(e?.response?.data?.detail || 'Ошибка создания задачи')
      setLoading(false)
    }
  }
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="Подробное описание задачи для агента..."
          ...
          <label className="flex items-center gap-3 cursor-pointer">
            ...
            />
            <span className="text-sm text-gray-400">Требует моего согласования</span>
          </label>
        </div>
